...
namespace AlmostEngine.Screenshot
{
    ...
    public class ScreenshotConfig
    {
        ...
        [UnityEngine.Tooltip("Override files or increment automatically the filenames.")]
        public bool m_OverrideFiles = false;

        [UnityEngine.Tooltip("Use PNG to create screenshots with a transparent background.")]
        public TextureExporter.ImageFormat m_Format;

        [UnityEngine.Tooltip("RGB is the default color format.\n" +
        ...
        [UnityEngine.Tooltip("Force alpha layer to be recomputed. This is a costly process. " +
        ...
        [UnityEngine.Tooltip("GAME_VIEW will capture what you see on the screen.\n" +
        ...
        [UnityEngine.Tooltip("Capture or not the active UI Canvas.")]
        ...
        [UnityEngine.Tooltip("If set to true, the camera and overlay settings will be applied when the application starts playing.")]
