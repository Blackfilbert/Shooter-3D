...
public class AppsFlyerObjectScript : MonoBehaviour , IAppsFlyerConversionData
{
    ...
    void Start()
    {
        ...
        AppsFlyerPurchaseConnector.setPurchaseRevenueDataSource(gameObject.GetComponent<CustomPurchaseRevenueDataSource>());

        AppsFlyer.waitForATTUserAuthorizationWithTimeoutInterval(60);

        AppsFlyer.startSDK();

        Debug.Log("[AppsFlyerServiceComponent] AppsFlyerPurchaseConnector initialized");
    }
